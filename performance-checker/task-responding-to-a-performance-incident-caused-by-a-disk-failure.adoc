...
+
En la línea de tiempo del evento, un punto rojo (image:../media/opm-incident-icon-png.gif["Icono de incidente de Performance Manager"]) indica cuándo se produjo el evento de fallo del disco.
