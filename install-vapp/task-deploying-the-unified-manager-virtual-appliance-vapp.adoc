...
Puede acceder a la interfaz de usuario web para realizar la configuración inicial de Unified Manager, tal como se describe en _Configuring Active IQ Unified Manager_.
