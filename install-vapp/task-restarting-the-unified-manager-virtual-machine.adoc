...
https://developer.broadcom.com/powercli/latest/vmware.vimautomation.core/commands/restart-vmguest["Referencia de cmdlets de VMware vSphere PowerCLI: Restart-VMGuest"^]
