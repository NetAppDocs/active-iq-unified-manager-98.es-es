...
+
La Storage Automation Store contiene paquetes de flujos de trabajo del almacenamiento automatizados certificados por NetApp, desarrollados para su uso con OnCommand Workflow Automation (WFA). Puedes descargar los paquetes y luego importarlos a WFA para ejecutarlos. Los flujos de trabajo automatizados están disponibles en Storage Automation Store.
