...
sidebar: sidebar 
keywords:  
summary: Puede utilizar la página Performance Thresholds para ver todas las políticas de umbral de rendimiento definidas actualmente. Esta página también proporciona la funcionalidad para crear, clonar, editar y eliminar políticas de umbral. 
---
...
[role="lead"]
Puede utilizar la página Performance Thresholds para ver todas las políticas de umbral de rendimiento definidas actualmente. Esta página también proporciona la funcionalidad para crear, clonar, editar y eliminar políticas de umbral.
