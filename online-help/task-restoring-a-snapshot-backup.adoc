...
summary: Si se produce la pérdida de datos o daños en los datos, es posible restaurar Unified Manager al estado estable anterior con la pérdida mínima de datos. Puede restaurar la base de datos de Unified Manager Snapshot a un sistema Red Hat Enterprise Linux o CentOS local o remoto mediante la consola de mantenimiento de Unified Manager. 
---
= Restaurar un backup de Snapshot
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Seleccione el archivo de copia de seguridad de Snapshot que desea restaurar y pulse Intro.
