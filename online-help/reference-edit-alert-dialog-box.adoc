...
[NOTE]
====
La pestaña exclude se muestra solo cuando selecciona todos los recursos de un tipo de recurso particular, por ejemplo, \<<All Volumes>> o \<<All Volumes whose name contains '_xyz_'>>.
