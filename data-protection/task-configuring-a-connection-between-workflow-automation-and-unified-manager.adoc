...
[NOTE]
====
El «`Paquete WFA para la gestión de Clustered Data ONTAP`» está incluido en WFA 5.1, por lo que ya no es necesario descargar este paquete de la Tienda de automatización de NetAppStorage e instalarlo por separado en tu servidor WFA, como se requería antes.  https://community.netapp.com/["PAQUETE WFA para gestionar ONTAP"^]
